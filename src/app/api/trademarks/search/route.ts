...
async function getAccessToken() {
  ...
  try {
    ...
    console.log(`Attempting intermediate GET to ${INPI_AUTH_URL} with XSRF token.`);
    try {
      ...
      console.log("Intermediate GET to INPI_AUTH_URL successful:", authResponse.status, authResponse.data);
    } catch (error) {
