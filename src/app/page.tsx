...
export default function TrademarkSearch() {
  ...
  return (
    <main className="container mx-auto p-4 max-w-4xl">
      <h1 className="text-3xl font-bold mb-8 text-center">Go to /v2test</h1>
      ...
      <div className="text-center p-4 text-gray-400">
        This will redirect you to the <b>/v2test</b> page of your current
        domain.
      </div>
    </main>
  );
}
// OLD CODE WITH SEARCH QUERY
// "use client";
